...
While the column-major format is generally more spatially efficient, the row-major format is more human-readable, and generally preferable for most tasks.
