...
% Title.
% ------
\title{Template for Extended Abstracts of the ISMIR~\conferenceyear\ Late-Breaking Demo Session}
...
This template includes all the information about formatting extended abstracts for the Late-Breaking Demo Session of the ISMIR \conferenceyear\ Conference.
...
(\texttt{ismir\conferenceyear-latebreak@ismir.net}).
This template can be downloaded from the ISMIR \conferenceyear\ web site (\texttt{http://ismir\conferenceyear.ismir.net}).
%
\section{Extended Abstract Length}
In contrast to regular papers, authors are required to submit one-page (preferred) or two-page (maximum) extended abstracts.

\section{Page Size}\label{sec:page_size}

The extended abstracts will be formatted as \underline{portrait A4-size} \underline{paper (21.0cm x 29.7cm)}. All material on each page should fit within a rectangle of 17.2cm x 25.2cm, centered on the page, beginning 2.0cm from the top of the page and ending with 2.5cm from the bottom. The left and right margins should be 1.9cm. The text should be in two 8.2cm columns with a 0.8cm gutter. All text must be in a two-column format. Text must be fully justified.
...
% For bibtex users:
\bibliography{ISMIR2015-LBD-template}
